...
class Person:
    ...
    def calories_calculator(self):
        ...
        weights=[1.2,1.375,1.55,1.725,1.9]    #number of times the bmr value for each activity= calorie consumed per day
...
class Display:
    ...
    def display_calories(self,person):
        ...
        maintain_calories=person.calories_calculator()  #calories consumed per day
        for plan,weight,col in zip(self.plans,self.weights,st.columns(4)):
            with col:
    ...
    def display_meal_choices(self,person,recommendations):    
        st.subheader('Choose your meal preference:')
        if len(recommendations)==3:
            ...
            with breakfast_column:
                breakfast_choice=st.selectbox(f'Choose your breakfast:',[recipe['Name'] for recipe in recommendations[0]])
            with morning_snack:
                morning_snack=st.selectbox(f'Choose your morning snack:',[recipe['Name'] for recipe in recommendations[1]])
            with launch_column:
            ...
            with afternoon_snack:
                afternoon_snack=st.selectbox(f'Choose your evening snack:',[recipe['Name'] for recipe in recommendations[3]])
            with dinner_column:
    ...
    "series": [
        {
            ...
            "label": {"show": False, "position": "center", "color":"white"},
            "emphasis": {
                "label": {"show": True, "fontSize": "40", "fontWeight": "bold", "color":"white"}
            },
            "labelLine": {"show": False,"color":"white"},
...
if generated:
    ...
    st.text('Generating recommendations...')     
